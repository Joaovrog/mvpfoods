...
import com.algajv.jvfoods.infrastructure.service.report.PdfVendaReportImpl;
...
public class EstatisticasController {
    ...
    public ResponseEntity<byte[]> consultarVendasDiariasPdf(VendaDiariaFilter filter, @RequestParam(required = false, defaultValue = "+00:00") String timeOffset) {
        ...
        headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=vendas-diarias.pdf"); // relatório para ser BAIXADO, não exibido em navegador
